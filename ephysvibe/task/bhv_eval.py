...
def compute_performance(
    ...
    perf[mask_correct_non_neutral] = np.where(
        match_mask[mask_correct_non_neutral], 1, perf[mask_correct_non_neutral]
    )
    # CR:
    ...
    if np.any(mask_error6):
        ...
        perf[mask_error6, last_valid_pos[mask_error6]] = 4
    return perf
